...
OUTPUT_TEMPLATE:{10}{9}_genONLY_converted.root
...
if __name__ == "__main__":
    ...
    parser.add_argument("--outdir",help="Specify full or relative path to output directory for jsub file",default=exe_abs_path+"../../sub_conversion_warehouse/")
